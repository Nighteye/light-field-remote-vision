/* -*-c++-*- */
/** \file regularizer_vtv_s.cpp

    Base data structure for the total variation regularizer.
    Reprojection for separate channels.
...
regularizer_vtv_s::regularizer_vtv_s()
{
}
...
bool regularizer_vtv_s::dual_prox( vector_valued_function_2D* P )
{
  assert( P != NULL );
  ...
  reprojection_max_norm( P, lambda, 0, _N );
  return true;
}
