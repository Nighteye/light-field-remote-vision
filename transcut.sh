...
do
	...
	do
		...
		ffmpeg -r 60 -f image2 -s 629x469 -i 'out/IBR_optical/transcut/obj'$i'_scn'$j'/3g_IBR_panning_%03lu.png' -vcodec libx264 -crf 15 'out/IBR_optical/transcut/obj'$i'_scn'$j'/3g_IBR_panning.mp4'
		rm 'out/IBR_optical/transcut/obj'$i'_scn'$j'/4g_IBR_panning.mp4'
		ffmpeg -r 60 -f image2 -s 629x469 -i 'out/IBR_optical/transcut/obj'$i'_scn'$j'/4g_IBR_panning_%03lu.png' -vcodec libx264 -crf 15 'out/IBR_optical/transcut/obj'$i'_scn'$j'/4g_IBR_panning.mp4'
		rm 'out/IBR_optical/transcut/obj'$i'_scn'$j'/6g_IBR_panning.mp4'
		ffmpeg -r 60 -f image2 -s 629x469 -i 'out/IBR_optical/transcut/obj'$i'_scn'$j'/6g_IBR_panning_%03lu.png' -vcodec libx264 -crf 15 'out/IBR_optical/transcut/obj'$i'_scn'$j'/6g_IBR_panning.mp4'		
	done
done
